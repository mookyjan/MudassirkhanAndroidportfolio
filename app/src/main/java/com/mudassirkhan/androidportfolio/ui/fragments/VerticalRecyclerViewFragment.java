...
public class VerticalRecyclerViewFragment extends BaseMovieRecyclerViewFragment {
    ...
    public String loaderBackgroundAction() {
        return JsonUtils.loadJsonFromAssetFolder(getActivity(), getString(R.string.moviesJsonFile2));
    }
