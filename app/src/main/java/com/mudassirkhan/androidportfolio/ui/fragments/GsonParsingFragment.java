...
public class GsonParsingFragment extends BaseMovieRecyclerViewFragment {
    ...
    public String loaderBackgroundAction() {
        return JsonUtils.loadJsonFromAssetFolder(getActivity(), getString(R.string.moviesJsonFile4));
    }
    ...
    protected List<Movie> chooseLoaderCallbackParsingMethod(String data) {
        return JsonUtils.getMovieListFromJsonThroughGson(getActivity(), data);
    }
